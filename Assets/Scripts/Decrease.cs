...
namespace DefaultNamespace
{
    public static class Decrease
    {
        ...
        private static void ConnectInnerStitches(StitchInfo myStitch)
        {
            ...
            VerletEdge.ConnectNodes(myStitch.corners[1],myStitch.corners[3],Calculation.CalculateDiagonal(_lastDecrease.width,_lastDecrease.height));
            myStitch.corners[1].SetShearEdge(false);
            VerletEdge.ConnectNodes(myStitch.corners[0],myStitch.corners[2],Calculation.CalculateDiagonal(_lastDecrease.width,_lastDecrease.height));
        }
