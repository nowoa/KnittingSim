...
namespace Verlet
{
    public class VerletSimOld
    {
        private List<VerletNodeOld> particles;
        public List<VerletNodeOld> Nodes => particles;
        private Vector3 _gravity = new Vector3(0, 0f, 0);

        public VerletSimOld(List<VerletNodeOld> particles)
        {
        ...
        void Solve(VerletNodeOld particle)
        {
        ...
        void Solve(VerletNodeOld a, VerletNodeOld b, float rest)
        {
