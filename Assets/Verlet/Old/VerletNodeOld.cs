...
namespace Verlet
{
    public class VerletNodeOld
    {
        ...
        public VerletNodeOld left;
        public VerletNodeOld up;
        public VerletNodeOld right;
        public VerletNodeOld down;
        ...
        public VerletNodeOld(Vector3 p)
        {
            Position = Prev = p;
        ...
        public VerletEdge FindEdgeByNode(VerletNodeOld other)
        {
        ...
        public void MergeInto(VerletNodeOld other)
        {
